...
const skillsData = [
    {
        ...
        link: '#',
        description: "lorem ipsum dolor sit amet consectetur adipisicing elit. Doloremque, quas!",
        aosDelay: '0',
    },
    {
        name:  "Fast and Safe",
...
const Services = () => {
  return (
    <div  className='py-14 dark:bg-black dark:text-white sm:min0h[600px] sm:grid sm:place-items-center'>
